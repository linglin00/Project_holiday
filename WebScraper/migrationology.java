...
public class migrationology {
	...
	private static void parseHtml(String blogUrl, String outputFile, BufferedWriter mapbw) {
		try {
	        ...
	        Elements plist = doc.select("article[id=content] > p");
	...
	public static void main(String[] args) {
		...
		try {
			...
			File file = new File("/home/ling/travelblog/migrationology/mapping.txt");
			BufferedWriter bw = new BufferedWriter(new FileWriter(file));
			int cnt = 0;
			for(String blogUrl : urlList) {
				cnt ++ ;
				String blogOutput = "/home/ling/travelblog/migrationology/blog_" + cnt + ".txt";
